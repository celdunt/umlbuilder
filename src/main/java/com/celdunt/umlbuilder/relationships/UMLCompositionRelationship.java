...
public class UMLCompositionRelationship extends UMLRelationship {

    public UMLCompositionRelationship(int sizeArrow, int numeratorOfRelations, int denominatorOfRelations) {
    ...
    void defineUpArrow() {
        ...
        upArrow.ypoints = new int[] {endY, endY + sizeArrow/2, endY + sizeArrow, endY + sizeArrow/2, endY};
        upArrow.npoints = 5;
    }
    ...
    void defineDownArrow() {
        ...
        downArrow.ypoints = new int[] {endY, endY - sizeArrow/2, endY - sizeArrow, endY - sizeArrow/2, endY};
        downArrow.npoints = 5;
    }

    @Override
    void defineLeftArrow() {
        leftArrow.xpoints = new int[] {endX, endX - sizeArrow/2, endX - sizeArrow, endX - sizeArrow/2, endX};
    ...
    void defineRightArrow() {
        rightArrow.xpoints = new int[] {endX, endX + sizeArrow/2, endX + sizeArrow, endX + sizeArrow/2, endX};
